...
export async function gradeTextAnswer(params: {
  ...
  prompt += '7. CHAT-LIKE ANSWER UNDERSTANDING (2026-و39 — mandatory): the student answer may be written like a CHAT MESSAGE: short, colloquial, incomplete, no formal math notation ("يعني 8", "الناتج ٢", "x تساوي 4", "هو 8 صح", "الإجابة الرابعة"). Judge the MEANING and the final VALUE, never the wording or format. If the wording differs from the model answer but the value/meaning is the same → CORRECT with full points. Colloquial fillers (يعني/بص/تقريبا), missing punctuation, spelling noise or casual phrasing NEVER make a correct value wrong. If a phrase is ambiguous, pick the most plausible mathematical reading that matches the model answer before deciding wrong; only mark wrong when the value/meaning is truly different.\n\n'
