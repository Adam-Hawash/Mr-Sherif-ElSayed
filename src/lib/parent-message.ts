/* ============================================================
   parent-message — رسالة ولي الأمر (و81 — منقول 1:1 من Maths-Genius)
   ============================================================
...
export const WA_TEACHER_NAME = 'Mr. Sherif ElSayed'
...
export const DEFAULT_PARENT_TEMPLATE = [
  'أهلاً حضرتكم 🌹',
  'الطالب/ة: {student}',
  'إحنا من منصة مستر شريف السيد بنتابع معاكم خطوة بخطوة، ودي آخر حالة للمستوى:',
  '',
  '📘 الامتحانات:',
  '{exams}',
  '',
