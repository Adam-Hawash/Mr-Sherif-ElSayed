...
function HeroDevIcon({ className }: { className?: string }) {
  return (
    ...
    <footer className="border-t bg-muted/30 mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8">
          ...
          <div className="flex items-center justify-center gap-5 mb-6">
            {yt && (
              <a href={yt} target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center h-10 w-10 rounded-full bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white transition-all duration-200"
                title="YouTube">
            ...
            {fb && (
              <a href={fb} target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center h-10 w-10 rounded-full bg-blue-600/10 text-blue-600 hover:bg-blue-600 hover:text-white transition-all duration-200"
                title="Facebook">
            ...
            {ig && (
              <a href={ig} target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center h-10 w-10 rounded-full bg-pink-500/10 text-pink-500 hover:bg-pink-500 hover:text-white transition-all duration-200"
                title="Instagram">
            ...
            {wa && (
              <a href={wa} target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center h-10 w-10 rounded-full bg-green-600/10 text-green-600 hover:bg-green-600 hover:text-white transition-all duration-200"
                title="WhatsApp">
        ...
        <div className="mt-6 pt-4 border-t border-border/40 text-center">
          <p className="text-xs sm:text-sm text-foreground flex flex-wrap items-center justify-center gap-x-1.5 gap-y-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              /* توقيع المطور — خط أكبر وواضح على الموبايل والديسكتوب (text-sm → text-base ديسكتوب) */
              className="text-sm sm:text-base font-bold text-foreground hover:text-primary hover:underline underline-offset-2 transition-colors"
            >
              {madeByLabel}
            </a>
          </p>
